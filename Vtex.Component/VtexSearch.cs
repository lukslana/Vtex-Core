...
namespace Vtex.Component
{
    ...
    /// </summary>
    public class VtexSearch
    {

        /// <summary>
        /// Retrieves general information about the products related to the term searched.
        /// </summary>
        public static HttpEngine<SearchForProductsRequest, SearchForProductsResponse> SearchForProducts => HttpEngine<SearchForProductsRequest, SearchForProductsResponse>.instance;
