...
{
    public class AddMarketingDataRequest : BaseRequest
    {
        protected internal override string BaseUrl => "api/checkout/pub/orderForm/{orderFormId}/attachments/marketingData";
