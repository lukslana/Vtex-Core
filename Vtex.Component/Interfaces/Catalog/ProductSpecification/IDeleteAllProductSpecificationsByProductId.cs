...
{
    public interface IDeleteAllProductSpecificationsByProductId : IApi<DeleteAllProductSpecificationsByProductIdRequest, DeleteAllProductSpecificationsByProductIdResponse>
    {
    }
}
